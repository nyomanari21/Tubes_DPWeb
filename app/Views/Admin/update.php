    ...
    <body>
        ...
        <section id="form-course">
            <div class="container my-5">
                <!-- Form -->
                <h2 class="text-center mb-3">Update Course</h2>
                <form action="<?= base_url('/course/save')?>/<?= $course['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="judul" value="<?= $course['judul'] ?>"
                        placeholder="Judul course" required>
                    </div>
                    <div class="mb-3">
                        <label for="subjudul" class="form-label">Subjudul</label>
                        <input type="text" class="form-control" name="subjudul" value="<?= $course['subjudul'] ?>"
                        placeholder="Subjudul course" required>
                    </div>
                    <div class="mb-3">
                        <label for="durasivideo" class="form-label">Durasi Video</label>
                        <input type="number" class="form-control" name="durasivideo" min="0" step=".1" value="<?= $course['durasivideo'] ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="jumlahpelajaran" min="0" value="<?= $course['jumlahpelajaran'] ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="harga" min="0" value="<?= $course['harga'] ?>"
                        placeholder="Tuliskan dalam angka tanpa titik dan koma ex: 549000" required>
                    </div>
                    <div class="mb-3">
						<label for="deskripsi" class="form-label">Deskripsi</label>
						<textarea name="deskripsi" class="form-control"
                        placeholder="Deskripsi course" required><?= $course['deskripsi'] ?></textarea>
					</div>
                    <div class="mb-3">
                        <label for="foto" class="form-label">Foto</label>
                        <input type="file" class="form-control" name="foto">
                    </div>
                    <input type="hidden" name="foto2" value="<?= $course['foto'] ?>">
