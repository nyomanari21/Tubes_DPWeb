            ...
            <div class="d-flex justify-content-center">
                <div class="container col-lg-4 col-md-6 col-sm-10 my-5">
                    ...
                    <form action="<?= base_url('/pengguna/save')?>" method="POST">
                        ...
                        <!-- Submit -->
                        <button type="submit" class="btn btn-dark" name="daftar">Daftar Menjadi Pengguna</button>
                    </form>
                    <p class="mt-3">Sudah punya akun? <a href="<?= base_url('/login')?>">Masuk Sekarang</a></p>
                    <p class="mt-3">Ingin mendaftar menjadi pengajar di AcaDemigod? <a href="<?= base_url('/signup-admin')?>">Daftar menjadi pengajar!</a></p>
                </div>
            </div>
        </section>
